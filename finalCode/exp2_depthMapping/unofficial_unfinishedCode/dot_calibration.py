...
def fun_predict(C_l,C_r,op,z_factor):
    ...
    print('\ncoefficient of determination for x:', r_sq)
    print('\ncoefficients for x:', coefficients_x, sep='\n')
    r_sq = model_y.score(ip, op[:,1])
    intercept, coefficients_y = model_y.intercept_, model_y.coef_
    print('\ncoefficient of determination for y', r_sq)
    print('\ncoefficients for y:', coefficients_y, sep='\n')
