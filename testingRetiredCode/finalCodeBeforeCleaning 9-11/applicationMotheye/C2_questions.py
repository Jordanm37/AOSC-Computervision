...
'''
Filtering tests:
img_gray = Convert rgb pattern to grayscale
img_gray1 = Convert bilateral filtered pattern to grayscale
img_gray2 = Sharpen bilateral filtered pattern img_gray1
img_gray3 = Blur rgb to grayscale of img_gray 
'''
...
'''
c2 = c[~(c==0).all(1)] #c2 is replacement without the deleted circle.
...
###Documentation to explain Hough circle 
'''
